...
class AddAlertsFragment : Fragment() {
    ...
    private fun setupWidgets() {
        ...
        binding.btnSave.setOnClickListener {
            if(clientId == -1 || visitDetailsId == -1) {
            ...
            viewModel.addAlerts(requireActivity(), clientId, visitDetailsId, binding.severityOfConcern.text.toString(), binding.visitNotes.text.toString(), fileList)
        }
        ...
        val adapter = ArrayAdapter(requireContext(), android.R.layout.simple_spinner_item, severityList)
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        binding.severityOfConcernSpinner.adapter = adapter

        binding.severityOfConcernSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
        ...
        binding.apply {
            bodyName.setOnClickListener {
                if(bodyName.tag == "Invisible") {
                    ...
                    bodyName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_up), null)
                    bodyItemLayout.visibility = View.VISIBLE
                } else {
                    bodyName.tag = "Invisible"
                    bodyName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_down), null)
                    bodyItemLayout.visibility = View.GONE
                }
            }

            layoutBodyFront.setOnClickListener {
                showBodyMapDialog("Body", "Body Front", requireContext().getDrawable(R.drawable.comp_body_front))
            }

            layoutBodyBack.setOnClickListener {
                showBodyMapDialog("Body", "Body Back", requireContext().getDrawable(R.drawable.comp_body_back))
            }

            faceName.setOnClickListener {
                if(faceName.tag == "Invisible") {
                    faceName.tag = "Visible"
                    faceName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_up), null)
                    faceItemLayout.visibility = View.VISIBLE
                } else {
                    faceName.tag = "Invisible"
                    faceName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_down), null)
                    faceItemLayout.visibility = View.GONE
                }
            }

            layoutFaceFront.setOnClickListener {
                showBodyMapDialog("Face", "Face Front", requireContext().getDrawable(R.drawable.comp_face_front))
            }

            layoutFaceBack.setOnClickListener {
                showBodyMapDialog("Face", "Face Back", requireContext().getDrawable(R.drawable.comp_face_back))
            }

            handName.setOnClickListener {
                if(handName.tag == "Invisible") {
                    handName.tag = "Visible"
                    handName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_up), null)
                    handItemLayout.visibility = View.VISIBLE
                } else {
                    handName.tag = "Invisible"
                    handName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_down), null)
                    handItemLayout.visibility = View.GONE
                }
            }

            layoutRightFront.setOnClickListener {
                showBodyMapDialog("Hand", "Right Front", requireContext().getDrawable(R.drawable.comp_hand_right_front))
            }

            layoutRightBack.setOnClickListener {
                showBodyMapDialog("Hand", "Right Back", requireContext().getDrawable(R.drawable.comp_hand_right_back))
            }

            layoutLeftFront.setOnClickListener {
                showBodyMapDialog("Hand", "Left Front", requireContext().getDrawable(R.drawable.comp_hand_left_front))
            }

            layoutLeftBack.setOnClickListener {
                showBodyMapDialog("Hand", "Left Back", requireContext().getDrawable(R.drawable.comp_hand_left_back))
            }

            pelvisName.setOnClickListener {
                if(pelvisName.tag == "Invisible") {
                    pelvisName.tag = "Visible"
                    pelvisName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_up), null)
                    pelvisItemLayout.visibility = View.VISIBLE
                } else {
                    pelvisName.tag = "Invisible"
                    pelvisName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_down), null)
                    pelvisItemLayout.visibility = View.GONE
                }
            }

            layoutPelvisFront.setOnClickListener {
                showBodyMapDialog("Pelvis", "Pelvis Front", requireContext().getDrawable(R.drawable.comp_pelvis_front))
            }

            layoutPelvisBack.setOnClickListener {
                showBodyMapDialog("Pelvis", "Pelvis Back", requireContext().getDrawable(R.drawable.comp_pelvis_back))
            }

            feetName.setOnClickListener {
                if(feetName.tag == "Invisible") {
                    feetName.tag = "Visible"
                    feetName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_up), null)
                    feetItemLayout.visibility = View.VISIBLE
                } else {
                    feetName.tag = "Invisible"
                    feetName.setCompoundDrawablesWithIntrinsicBounds(null, null, requireContext().getDrawable(R.drawable.ic_keyboard_arrow_down), null)
                    feetItemLayout.visibility = View.GONE
                }
            }

            layoutRightFrontFeet.setOnClickListener {
                showBodyMapDialog("Feet", "Right Front", requireContext().getDrawable(R.drawable.comp_feet_right_front))
            }

            layoutRightBackFeet.setOnClickListener {
                showBodyMapDialog("Feet", "Right Back", requireContext().getDrawable(R.drawable.comp_feet_right_back))
            }

            layoutRightHeelFeet.setOnClickListener {
                showBodyMapDialog("Feet", "Right Heel", requireContext().getDrawable(R.drawable.comp_feet_right_heel))
            }

            layoutLeftFrontFeet.setOnClickListener {
                showBodyMapDialog("Feet", "Left Front", requireContext().getDrawable(R.drawable.comp_feet_left_front))
            }

            layoutLeftBackFeet.setOnClickListener {
                showBodyMapDialog("Feet", "Left Back", requireContext().getDrawable(R.drawable.comp_feet_left_back))
            }

            layoutLeftHeelFeet.setOnClickListener {
                showBodyMapDialog("Feet", "Left Heel", requireContext().getDrawable(R.drawable.comp_feet_left_heel))
            }
        }
